...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: "সোয়াপ করতে কি টাকা লাগে?",
        a: "না, সোয়াপ সম্পূর্ণ বিনামূল্যে। শুধু শিপিং খরচ প্রযোজ্য হতে পারে।",
      },
      {
        q: "কীভাবে সোয়াপ শুরু করব?",
        a: "আপনার বই আপলোড করুন, পছন্দের বইয়ে সোয়াপ অফার পাঠান। দুইজন রাজি হলেই সোয়াপ হয়ে যাবে।",
      },
    ],
  },
];
