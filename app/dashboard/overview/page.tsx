        ...
        <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-3 border-t border-white/10 pt-5 lg:items-end lg:border-t-0 lg:pt-0">
            ...
            <div className="flex w-full items-center gap-2 lg:w-auto">
              <Link
                href="/books/upload"
                className="inline-flex min-h-[40px] flex-1 items-center justify-center gap-1.5 rounded-xl bg-white px-5 py-2 text-xs font-extrabold text-[#0397d3] shadow-md transition-all hover:bg-white/90 active:scale-95 lg:flex-none"
              >
