...
// Only export basic layout, since we need to use 'use client'
// We cannot export metadata from a client component, so we remove the metadata export.
  ...
  return (
    <div className="boimix-container py-6 md:py-8">
      ...
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="type-heading text-3xl md:text-4xl">সব বই</h1>
          <p className="text-muted-foreground mt-1 text-sm md:text-base">
            আপনার পছন্দের বই খুঁজুন, ধার নিন বা সোয়াপ করুন
          </p>
        </div>
        <div className="flex w-full flex-col gap-3 md:w-auto md:flex-row">
          <div className="relative w-full md:w-80">
            <Search className="text-muted-foreground absolute top-1/2 left-3 size-4 -translate-y-1/2" />
            <Input placeholder="বইয়ের নাম, লেখক বা ISBN..." className="pl-9" />
          </div>
